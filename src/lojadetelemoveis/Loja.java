...
public class Loja implements Serializable {
    ...
    public int consultarCliente(String nome) {      //Função que procura no array Clientes através do Nome
        ...
        if (aux > 1) {      //Se "aux > 1" significa que existe mais de um cliente com o mesmo nome
            return -1;
        } else {            //Se "aux < 1 / else" significa que não existe nenhum cliente com o nome pesquisado
            return -2;
        }
    }
